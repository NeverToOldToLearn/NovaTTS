...
powershell -NoProfile -Command "try { Invoke-RestMethod http://127.0.0.1:8765/shutdown -Method Post -TimeoutSec 3 2>$null | Out-Null; Write-Host 'backend shutdown' } catch { Write-Host 'backend shutdown (skipped)' }" 2>nul
